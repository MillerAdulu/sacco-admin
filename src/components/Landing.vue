      ...
      <section>
        <v-parallax :src="require('../assets/section.jpg')" height="380">
          <v-layout column align-center justify-center>
            ...
            >Being a Sacco member has never been easier</div>
            <v-btn class="blue lighten-2 mt-5" dark large :href="oAuthURL">Log In</v-btn>
          </v-layout>
        </v-parallax>
      </section>
          ...
          <v-layout row wrap justify-center class="my-5">
            ...
            <v-flex xs12 sm4 offset-sm1>
              <v-card class="elevation-0 transparent">
                ...
                <v-card-text>We are located here.</v-card-text>
                <v-list class="transparent">
                  <v-list-tile>
                    ...
                    <v-list-tile-content>
                      <v-list-tile-title>+254 777 777 777</v-list-tile-title>
                    </v-list-tile-content>
                  </v-list-tile>
                  <v-list-tile>
                    <v-list-tile-action>
                    ...
                    <v-list-tile-content>
                      <v-list-tile-title>Nairobi, Kenya</v-list-tile-title>
                    </v-list-tile-content>
                  </v-list-tile>
                  <v-list-tile>
                    <v-list-tile-action>
                    ...
                    <v-list-tile-content>
                      <v-list-tile-title>info@sacco.com</v-list-tile-title>
                    </v-list-tile-content>
                  </v-list-tile>
                </v-list>
              </v-card>
