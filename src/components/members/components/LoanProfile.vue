<template>
  <v-data-iterator :items="memberloans" :rows-per-page-items="rowsPerPageItems">
      ...
      <v-card>
        ...
        <v-list dense>
          ...
          <v-list-tile>
            ...
            <v-list-tile-content
              class="align-end"
            >{{ props.item.loanRepaymentStatus.loanRepaymentStatus}}</v-list-tile-content>
          </v-list-tile>
          <v-list-tile>
            <v-list-tile-content>Loan Repayment Status</v-list-tile-content>
          ...
          <v-list-tile>
            ...
            <v-list-tile-content
              class="align-end"
            >{{ moment(props.item.createdAt).format('MMMM Do YYYY, h:mm:ss a') }}</v-list-tile-content>
          </v-list-tile>
          <v-list-tile>
            <v-list-tile-content>
              <router-link :to="`/memberloans/${ props.item.memberLoanId }`">
                <v-icon>list</v-icon>
              </router-link>
            </v-list-tile-content>
          </v-list-tile>
